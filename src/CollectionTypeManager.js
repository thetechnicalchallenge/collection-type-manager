...
export default class CollectionTypeManager {
  ...
  addElement () {
    ...
    const removeButton = widgetContainer.children[0].getElementsByClassName(this.settings.removeButtonsClassName)[0];
    removeButton.addEventListener('click', this.removeElement.bind(this, removeButton));
  ...
  sortFieldNames () {
    this.fields = [];
    const collectionItems = Array.from(this.container.children);
